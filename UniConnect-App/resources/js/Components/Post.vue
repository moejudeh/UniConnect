...
<template>
    <div id = "Post" class = "w-full bg-white rounded-lg my-4 shadow-md">
        ...
        <img class="mx-auto cursor-pointer"  @click="isImageDisplay = post.image" :src="post.image"/>
        <div id="Likes" class="px-5">
            <div class="flex items-center justify-between py-3 border-b">
                <ThumbUp fillColor="#5800AE" :size="16"/>
              ...
              <div class="flex items-center w-full">
                ...
                <div class="flex items-center justify-center bg-[#EFF2F5] p-2 rounded-full w-full">
                    ...
                    <button
                        type="button"
                        @click="createComment"
                        class="flex items-center text-sm pl-2 pr-3.5 rounded-full bg-gray-500 hover:bg-purple-600 text-white font-bold"
                    >
